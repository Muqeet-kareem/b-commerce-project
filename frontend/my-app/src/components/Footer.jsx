    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Address:</b>  10, Olanrewaju Street, Oregun Ikeja Lagos State</p> </div>
          <div className='mb-3'><p><b>Phone:</b>  <a className='footer-tel' href="tel:+1234567890">Call us at +234-70-18-193-173</a></p> </div>
          ...
          <Link to='https://instagram.com/Muqeet_Kareem' id='footer-link' target='_blank' className='gap-3'>
          <BsInstagram />
          </Link>
          <Link to='https://twitter.com/MuqeetKareem' id='footer-link' target='_blank' className='gap-3'>
          <BsTwitter />
          </Link>
          <Link to={'https://github.com/MuqeetKareem'} className='gap-3' id='footer-link'>
          <BsGithub />
          </Link>
          ...
          <Link to='https://facebook.com/MuqeetKareem' id='footer-link' target='_blank' className='gap-3'>
          <BsFacebook />
          </Link>
          </div>
        </div>
      ...
      <div className="row">
        ...
        <p className="text-center text-md-start">&copy;Developed by Muqeet Kareem 2023</p>
        </div>
        <div className="col-12 col-md-6">
