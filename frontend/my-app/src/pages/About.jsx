...
import video from '../assets/app video.mp4'
import Marquee from "react-fast-marquee";
import orders from '../assets/icon1.png'
import orders1 from '../assets/icon2.png'
import orders2 from '../assets/icon3.png'
import orders3 from '../assets/icon4.png'
import orders4 from '../assets/icon5.png'
import orders5 from '../assets/icon6.png'
    ...
    <section className="about-app p-5">
      ...
      <div className="col-12 p-5 col-md-8 mx-auto">
        {isMobile ? (
          ...
          <img src={mobileImage} alt="Mobile Img" className='w-100' />
        ) : (
