...
import banner from '../assets/b17.jpg'
...
function Home() {
    return <>
    <section data-aos="zoom-in" className="banner">
          ...
          <div className="d-flex flex-column justify-content-center ">
            <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                  ...
                  <p className='mb-3'>Save more today with Muqeet Limited</p>
  ...
  <section data-aos="zoom-in" className="repair-services p-5">
    <div className="container-xxl">
      <div className="row ">
  ...
  <section data-aos="zoom-in" className="hot-deals p-5 d-flex flex-column flex-md-row justify-content-center align-items-center align-items-md-start">
    <div className="container-xxl">
      <div className="row">
        ...
        <div data-aos="zoom-in" className="col-md-6 d-flex">
